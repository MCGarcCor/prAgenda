...
new Contacto("Pepe","Montes","pepe.montes@hotmail.com","111222333"));
...
System.out .println("El número de contactos con dirección en gmail.com es: " +
agenda.nrContactosConEmail("gmail.com"));
// Eliminamos la agenda
agenda.eliminaTodos(contacto);
